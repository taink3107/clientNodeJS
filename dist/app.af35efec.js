...
function () {
  ...
  PersonRespository.prototype.findAll = function () {
    var p = [];
    $.ajax({
      url: Constants_1.ENDPOINT.person.list,
      method: 'GET',
...
function () {
  ...
  PersonServie.prototype.getAll = function () {
...
},{"../repo/PersonRespository":"app/repo/PersonRespository.ts"}],"app/index.ts":[function(require,module,exports) {
"use strict";

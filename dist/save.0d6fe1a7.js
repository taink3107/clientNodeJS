...
/** @class */
function () {
  function Person(fisrtname, lastname, age, salary, dob, status) {
...
/** @class */
function () {
  function PersonRespository() {}

  PersonRespository.prototype.findAll = function (param) {
    var p = [];
    $.ajax({
      url: Constants_1.ENDPOINT.person.list + "?search=" + param,
      method: 'GET',
  ...
  PersonRespository.prototype.findOne = function (k) {
    var p = new Person_1.Person(null, null, null, null, null, null);
    $.ajax({
      url: Constants_1.ENDPOINT.person.personID.replace("{id}", k),
      method: 'GET',
      contentType: 'application/json',
      async: false,
      success: function success(data) {
  ...
  PersonRespository.prototype.save = function (per) {
    $.ajax({
      url: Constants_1.ENDPOINT.person.save,
      method: 'POST',
      contentType: 'application/json',
...
/** @class */
function () {
  function PersonServie() {
    this.pr = new PersonRespository_1.PersonRespository();
  }

  PersonServie.prototype.getAll = function (param) {
...
$("#save").click(function (e) {
  ...
  var dob = new Date($("#dob").val().toString());
  var temp = $("#status").val();
  var status = temp == 2 ? "ACTIVE" : "INACTIVE";
  var per = new Person_1.Person(first_name.toString(), last_name.toString(), +age, +salary, dob, status.toString());
  console.log(per);
...
$(document).ready(function () {
  $("#submitTask").click(function (e) {
    ...
    new TaskService_1.TaskService().save(task); //text.html();
  });
...
},{}]},{},["C:/Users/Tai Khanh Nguyen/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","app/save.ts"], null)
//# sourceMappingURL=/save.0d6fe1a7.js.map